...
export default function Login() {
    ...
    const handleClick = (setType: "register" | "forgotPassword") => setAuthModelState((prev) => ({...prev, type: setType}));
    ...
    return <form className='space-y-6 px-6 pb-4' onSubmit={handleLogin}>
        ...
        <div>
            ...
            <input onChange={handleInputChange} type="email" name="email" id="email" className="border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
