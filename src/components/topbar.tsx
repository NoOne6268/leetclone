    ...
    return <nav className='relative flex h-[50px] w-full shrink-0 items-center px-5 bg-dark-layer-1 text-dark-gray-7'>
        <div className={`flex w-full items-center justify-between ${!problemPage ? "max-w-[1200px] mx-auto" : ""}`}>
            ...
            <div className='flex items-center space-x-4 flex-1 justify-end'>
                <div>
                    <a
                        href='https://github.com/NoOne6268'
                        target='_blank'
                        rel='noreferrer'
                        className='flex justify-center items-center bg-dark-fill-3 py-1.5 px-3 cursor-pointer rounded text-brand-orange hover:bg-dark-fill-2'
                    >
                        <FaGithub className="mr-2" />NoOne6268
                    </a>
                </div>
                {!user &&
                    <Link
